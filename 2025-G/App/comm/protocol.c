...
uint16_t VppToAmp(uint32_t vpp_raw, uint8_t mul)
{
    ...
    float amp = vpp * 2275.0f;                   /* V → DAC 码，修改乘的系数以调参 */
    amp *= (float)mul;
...
static const float s_amp_comp_tbl[] = {
   0.2211f, 0.2245f, 0.2381f, 0.2577f, 0.2794f,  /*  100 ~  500 */
    0.3042f, 0.3314f, 0.3606f, 0.3916f, 0.4243f,  /*  600 ~ 1000 */
    0.4581f, 0.4905f, 0.5267f, 0.5675f, 0.6027f,  /* 1100 ~ 1500 */
    0.6424f, 0.6832f, 0.7251f, 0.7682f, 0.8124f,  /* 1600 ~ 2000 */
    0.8577f, 0.9043f, 0.9467f, 0.9895f, 1.0391f,  /* 2100 ~ 2500 */
    1.0899f, 1.1421f, 1.1955f, 1.2502f, 1.3062f,  /* 2600 ~ 3000 */
};
