...
{
    uint32_t Temp; 
    Temp = (uint32_t)(Freq * (4294967296.0 / AD9910_SYSCLK_HZ));
...
void AD9910_RAM_WAVE_Set(AD9910_WAVE_ENUM wave)
{
    ...
    switch (wave)
    {
    case AD9910_WAVE_TRI:   srcWaveDta = RAM_TRIG_WAVE;   break;
    case AD9910_WAVE_SQR:   srcWaveDta = RAM_SQUARE_WAVE; break;
    case AD9910_WAVE_SINC:  srcWaveDta = RAM_SINC_WAVE;   break;
...
void AD9910_DRG_FrePara_Set(uint32_t lowFre, uint32_t upFre, uint32_t posStep, uint32_t negStep, uint16_t posRate, uint16_t negRate)
{
    ...
    const double factor = 4294967296.0 / AD9910_SYSCLK_HZ;
